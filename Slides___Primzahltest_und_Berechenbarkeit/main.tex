...
\]
Wir substituieren den Laufindex durch $j:=l-i$ und ersetzen die Indexgrenzen. Für $i=1$ erhalten wir die neue indexgrenze $j=l-1$ und für $i=l$ erhalten wir die neue Indexgrenze $j=0$.
...
\begin{itemize}
    \item Stefan Hougardy und Jens Vygen: \\
